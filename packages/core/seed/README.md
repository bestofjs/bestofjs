...
- Import tags from `tags.json` file running `bun run packages/core/seed/import-tags.ts`
- Import projects from `projects.json` file running `bun run packages/core/seed/import-projects.ts`
- Import snapshots from `snapshots.json` file running, for every year `bun run packages/core/seed/import-projects.ts 2024`

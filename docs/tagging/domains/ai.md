...
Apply the global [tagging conventions](../conventions.md) alongside these
...
**Description:** Frameworks, patterns, and systematic approaches for AI-assisted development workflows. These are meta-tools that guide _how_ teams work with AI agents, rather than libraries to build AI features into applications.
